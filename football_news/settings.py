...
SECRET_KEY = 'django-insecure-8y66&ud%qzl-o4y9i17iyx*ntw3*mnv!o1#bboa+#8yox9ctec'

PRODUCTION = os.getenv('PRODUCTION', 'False').lower() == 'true'
# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["localhost", "127.0.0.1", "radithya-naufal-footballnews.pbp.cs.ui.ac.id"]
